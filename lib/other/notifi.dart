...
import 'package:flutter_notifications_app/other/plugin.dart';
import 'package:flutter_notifications_app/other/screen.dart';
...
class _LocalNotificationScreenState extends State<LocalNotificationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('New Local Notifications'),
      ),
      body: Center(
        child: RaisedButton(
          onPressed: () async {
